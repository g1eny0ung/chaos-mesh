...
export const getPostCommonPodsMockHandler = (
  overrideResponse?:
    TypesPod[] | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<TypesPod[]> | TypesPod[]),
  options?: RequestHandlerOptions,
) => {
  return http.post(
    '*/common/pods',
...
export const getGetEventsMockHandler = (
  overrideResponse?:
    CoreEvent[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<CoreEvent[]> | CoreEvent[]),
  options?: RequestHandlerOptions,
) => {
  return http.get(
    '*/events',
...
export const getPutExperimentsPauseUidMockHandler = (
  overrideResponse?:
    UtilsResponse | ((info: Parameters<Parameters<typeof http.put>[1]>[0]) => Promise<UtilsResponse> | UtilsResponse),
  options?: RequestHandlerOptions,
) => {
  return http.put(
